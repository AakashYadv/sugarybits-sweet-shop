          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                ${isAdmin && html`<th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Customer</th>`}
                ...
                ${isAdmin && html`<th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Actions</th>`}
              </tr>
            </thead>
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              ${orders.map((order) => html`
                <tr key=${order.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  ...
                  ${isAdmin && html`<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white font-semibold">${order.username}</td>`}
                  ...
                  ${isAdmin && html`
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                       ...
                       >
                         ${Object.values(OrderStatus).map(s => html`
