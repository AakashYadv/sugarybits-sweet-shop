...
import { Address, PaymentDetails } from '../types.ts';

interface CheckoutViewProps {
  totalAmount: number;
  onSubmit: (address: Address, payment: PaymentDetails) => void;
  onCancel: () => void;
}

const CheckoutView: React.FC<CheckoutViewProps> = ({ totalAmount, onSubmit, onCancel }) => {
